 ...
 *
 */
public class ApiSecurityException extends AbstractAPIException {

	private static final long serialVersionUID = 1L;

	public static void lancarSeTiverErros(List<Erro> erros) throws ApiSecurityException {
	...
	public static void lancarSeTiverErro(Erro erro) throws ApiSecurityException {
