...
public interface RankingApi {
    ...
    @ApiOperation(value = "Operação utilizada para consultar os rankings do produto informado.", notes = "Operação utilizada para consultar os rankings do produto informado.", response = Rankings.class, tags={ "Rankings", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<Rankings> rankingGet(@ApiParam(value = "Número da página.", required = true) @RequestParam(value = "page", required = true) Long page
...
,@ApiParam(value = "Recebe o(s) nome(s) do(s) campo(s) do ranking do produto  a ser ordenado. Campos disponível são: nota") @RequestParam(value = "order", required = false) Integer order
    ...
    @ApiOperation(value = "Operação utilizada para se obter um ranking.", notes = "", response = Ranking.class, tags={ "Rankings", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Sucesso", response = Ranking.class),
    ...
    @RequestMapping(value = "/ranking/{idRanking}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Ranking> rankingIdRankingGet(
@ApiParam(value = "Identificador do Ranking.",required=true ) @PathVariable("idRanking") Long idRanking
    ...
    @ApiOperation(value = "Operação utilizada para calcular as notas do ranking do produto.", notes = "Operação utilizada para calcular as notas do ranking do produto.", response = Nota.class, tags={ "Rankings", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/ranking/notas/{idProduto}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Nota> rankingNotasIdProdutoGet(
@ApiParam(value = "Identificador do produto.",required=true ) @PathVariable("idProduto") Long idProduto
    ...
    @ApiOperation(value = "Operação utilizada para criar um ranking do produto.", notes = "Operação utilizada para criar um ranking do produto.", response = Void.class, tags={ "Rankings", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<Void> rankingPost(
